...
import com.base.frame.utils.log.LogUtilHelper;
...
public final class HttpLoggingInterceptorM implements Interceptor {
    ...
    public enum Level {
         ...
         * <p>Example:
         * <pre>{@code
         * --> POST /greeting com.cheng.simplemvp.http/1.1 (3-byte body)
         *
         ...
         * <p>Example:
         * <pre>{@code
         * --> POST /greeting com.cheng.simplemvp.http/1.1
         * Host: example.com
